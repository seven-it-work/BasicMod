...
public abstract class QuickStartPotion extends AbstractPotion {
    ...
    public QuickStartPotion(String id, int potency, PotionRarity rarity, PotionSize shape, Color liquidColor, Color hybridColor, Color spotsColor) {
    ...
    public QuickStartPotion(String id, int potency, PotionRarity rarity, PotionSize size, PotionColor color) {
