package org.seven.jywx.cards;

import basemod.BaseMod;
import basemod.abstracts.CustomCard;
import basemod.abstracts.DynamicVariable;
import org.seven.jywx.JYWXMod;
import org.seven.jywx.util.CardStats;
import org.seven.jywx.util.TriFunction;
...
import static org.seven.jywx.util.GeneralUtils.removePrefix;
import static org.seven.jywx.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return JYWXMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    JYWXMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
