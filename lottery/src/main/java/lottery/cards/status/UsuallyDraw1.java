...
public class UsuallyDraw1 extends BaseDraw {
    public static final String ID = LotteryMod.resourcePath.makeID(UsuallyDraw1.class.getSimpleName());
    ...
    public UsuallyDraw1() {
        super(ID, info,
            BaseDraw.Probability.builder().basic(35).common(35).uncommon(10).rare(10).special(5).curse(5).build());
        setMagic(1, 1);
    }
}
