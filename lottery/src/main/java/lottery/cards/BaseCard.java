...
public abstract class BaseCard extends CustomCard {
    ...
    private static final Logger logger = LogManager.getLogger(BaseCard.class);
    ...
    public BaseCard(String ID, CardStats info) {
        this(ID, info, getCardTextureString(removePrefix(ID), info.cardType, LotteryMod.resourcePath));
    }
    ...
    public BaseCard(String ID, int cost, CardType cardType, CardTarget target, CardRarity rarity, CardColor color) {
        this(ID, cost, cardType, target, rarity, color, getCardTextureString(removePrefix(ID), cardType, LotteryMod.resourcePath));
    }
    ...
    private static class QuickDynamicVariable extends DynamicVariable {
        ...
        public QuickDynamicVariable(String key) {
            this.localKey = key;
            this.key = LotteryMod.resourcePath.makeID(key);
        }
