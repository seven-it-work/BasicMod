...
public class DefaultDefault extends BaseCard {
    public static final String ID = LotteryMod.resourcePath.makeID(DefaultDefault.class.getSimpleName());

    private static final CardStats info = new CardStats(LotteryMod.PlayerColorEnum.BASE_LU_SHI_PLAYER_CARD_COLOR, CardType.SKILL, CardRarity.BASIC,
            CardTarget.SELF, 1);
